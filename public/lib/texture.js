...
function MTexture(opts) {
  if (!(this instanceof MTexture)) return new MTexture(opts || {});
  var self = this;
...
MTexture.prototype.load = function(names, done) {
  var self = this;
...
MTexture.prototype.pack = function(name, done) {
  var self = this;
  function pack(img) {
...
MTexture.prototype.find = function(name) {
  var self = this;
  var type = 0;
...
MTexture.prototype._expandName = function(name) {
...
MTexture.prototype._afterLoading = function() {
  var self = this;
  function alldone() {
    self.loading--;
...
// this is cheating :D
MTexture.prototype._powerof2 = function(done) {
...
MTexture.prototype.paint = function(mesh, materials) {
  var self = this;
...
MTexture.prototype.sprite = function(name, w, h, cb) {
  var self = this;
...
MTexture.prototype.animate = function(mesh, names, delay) {
  var self = this;
  delay = delay || 1000;
...
MTexture.prototype.tick = function(dt) {
  tic.tick(dt);
};

MTexture.prototype.setColor = function(face, color) {
...
MTexture.prototype._lightDark = memoize(function(color) {
